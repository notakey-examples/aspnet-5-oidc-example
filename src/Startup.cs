    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddOpenIdConnect(options =>
            {
                ...
                // Map just phone attribute from userinfo
                options.ClaimActions.MapUniqueJsonKey(ClaimTypes.MobilePhone, "phone_number");

                // Maps all attributes to claims
                // options.ClaimActions.MapAll();

                // Map group attributes (a Json array) to role claim
                options.ClaimActions.Add(new JsonKeyArrayClaimAction(ClaimTypes.Role, ClaimValueTypes.String, "groups"));
            });
